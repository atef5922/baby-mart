...
export const products: Product[] = [
  ...
  {
    id: "p-014",
    slug: "philips-adventure-baby-shorts",
    name: "Philips Avent Adventure Baby Shorts",
    brand: "Philips Avent",
    category: "clothing",
    price: 1950,
    oldPrice: 2450,
    ...
    reviewCount: 60,
    stock: 11,
    warranty: "1 Year Soft Wear Warranty",
    badge: "Playwear",
    image: babyProductImages.shorts,
    gallery: [babyProductImages.shorts, babyProductImages.shorts, babyProductImages.shorts],
    features: ["Double-layered cotton lining", "Elastic leg openings for easy movement", "Machine washable", "Toddler-friendly stretch fit"],
    specifications: { Fabric: "Soft Cotton", Size: "1Y - 3Y", Fit: "Loose", WashCare: "Machine Wash" },
    tags: ["clothing", "shorts", "activewear", "kids-play", "toddler"],
